...
## 
# @file lua_IMU_adapter.py 
# @author Davide Piccinini <piccio98dp\@gmail.com>
# @date 24 March 2021
# @brief This file contains the left upper arm IMU adapter.
...
def luaAdapter():
    ...
    print("Left upper arm IMU adapter: Running...")
...
if __name__ == "__main__":
    try:
        rospy.init_node('lua_IMU_adapter')
        ...
        samplePub = rospy.Publisher("lua_IMU_data", ImuSample, queue_size=1)
